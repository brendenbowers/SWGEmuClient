...
float FSWGMapFractal::GetNoise(float X, float Y) const
{
	...
	// The octave sum above isn't strictly bounded and occasionally dips just
	// under 0; Pow() with a negative base and non-integer exponent is NaN,
	// which bakes into the heightmap as needle-thin spike artifacts.
